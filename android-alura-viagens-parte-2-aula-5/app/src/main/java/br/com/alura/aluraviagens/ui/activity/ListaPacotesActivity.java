...
public class ListaPacotesActivity extends AppCompatActivity {
     ...
     private void configuraLista() {
          ...
          clickNaLista(listaDePacotes, pacotes);
     }

     private void clickNaLista(ListView listaDePacotes, final List<Pacote> pacotes) {
     ...
     private void vaiParaResumoPacote(Pacote pacoteClicado) {
          ...
          intent.putExtra(CHAVE_PACOTE, pacoteClicado);//Passa dados a patir desta activity
